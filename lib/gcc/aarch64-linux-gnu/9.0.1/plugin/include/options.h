...
enum opt_code
{
  ...
  OPT_fconstexpr_ops_limit_ = 607,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 608,                       /* -fconvert= */
  OPT_fcprop_registers = 609,                /* -fcprop-registers */
  OPT_fcray_pointer = 610,                   /* -fcray-pointer */
  OPT_fcrossjumping = 611,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 612,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 613, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 614,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 615,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 616,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 617,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 618,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 619,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 620,                       /* -fdbg-cnt= */
  OPT_fdce = 621,                            /* -fdce */
  OPT_fdebug = 622,                          /* -fdebug */
  OPT_fdebug_cpp = 623,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 624,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 625,            /* -fdebug-types-section */
  OPT_fdebug_ = 626,                         /* -fdebug= */
  OPT_fdec = 627,                            /* -fdec */
  OPT_fdec_include = 628,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 629,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 630,                       /* -fdec-math */
  OPT_fdec_static = 631,                     /* -fdec-static */
  OPT_fdec_structure = 632,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 633,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 634,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 635,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 636, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 637,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 638,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 639,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 640,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 641,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 642,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 643,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 644,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 645,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 646,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 647,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 648, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 649,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 650,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 651,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 652,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 653,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 654,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_labels = 655,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 656,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 657,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 658,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 659, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 660,                /* -fdirectives-only */
  OPT_fdisable_ = 661,                       /* -fdisable- */
  OPT_fdoc = 662,                            /* -fdoc */
  OPT_fdoc_dir_ = 663,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 664,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 665,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 666,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 667,         /* -fdollars-in-identifiers */
  OPT_fdse = 668,                            /* -fdse */
  OPT_fdump_ = 669,                          /* -fdump- */
  OPT_fdump_ada_spec = 670,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 671,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 672, */                /* -fdump-core */
  OPT_fdump_d_original = 673,                /* -fdump-d-original */
  OPT_fdump_final_insns = 674,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 675,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 676,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 677,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 678,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 679,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 680,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 681, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 682,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 683,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 684,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 685,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 686,                 /* -fearly-inlining */
  OPT_felide_constructors = 687,             /* -felide-constructors */
  OPT_felide_type = 688,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 689, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 690, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 691,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 692,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 693,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 694,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 695,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 696,                        /* -fenable- */
  OPT_fenforce_eh_specs = 697,               /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 698,                 /* -fenum-int-equiv */
  OPT_fexceptions = 699,                     /* -fexceptions */
  OPT_fexcess_precision_ = 700,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 701,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 702,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 703,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 704,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 705,                /* -fextern-tls-init */
  OPT_fexternal_blas = 706,                  /* -fexternal-blas */
  OPT_fexternal_templates = 707,             /* -fexternal-templates */
  OPT_ff2c = 708,                            /* -ff2c */
  OPT_ffast_math = 709,                      /* -ffast-math */
  OPT_ffat_lto_objects = 710,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 711,               /* -ffile-prefix-map= */
  OPT_ffinite_math_only = 712,               /* -ffinite-math-only */
  OPT_ffixed_ = 713,                         /* -ffixed- */
  OPT_ffixed_form = 714,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 715,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 716,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 717,                    /* -ffloat-store */
  OPT_ffor_scope = 718,                      /* -ffor-scope */
  /* OPT_fforce_addr = 719, */               /* -fforce-addr */
  OPT_fforward_propagate = 720,              /* -fforward-propagate */
  OPT_ffp_contract_ = 721,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 722,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 723,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 724,                      /* -ffpe-trap= */
  OPT_ffree_form = 725,                      /* -ffree-form */
  OPT_ffree_line_length_ = 726,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 727,          /* -ffree-line-length-none */
  OPT_ffreestanding = 728,                   /* -ffreestanding */
  OPT_ffriend_injection = 729,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 730,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 731,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 732,                   /* -ffunction-cse */
  OPT_ffunction_sections = 733,              /* -ffunction-sections */
  OPT_fgcse = 734,                           /* -fgcse */
  OPT_fgcse_after_reload = 735,              /* -fgcse-after-reload */
  OPT_fgcse_las = 736,                       /* -fgcse-las */
  OPT_fgcse_lm = 737,                        /* -fgcse-lm */
  OPT_fgcse_sm = 738,                        /* -fgcse-sm */
  OPT_fgimple = 739,                         /* -fgimple */
  OPT_fgnat_encodings_ = 740,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 741,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 742,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 743,                         /* -fgnu-tm */
  OPT_fgnu_unique = 744,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 745,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 746,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 747,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 748,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 749,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 750,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 751,          /* -fgo-debug-escape-hash= */
  OPT_fgo_dump_ = 752,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 753,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 754,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 755,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 756,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 757,                       /* -fgraphite */
  OPT_fgraphite_identity = 758,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 759,       /* -fguess-branch-probability */
  OPT_fguiding_decls = 760,                  /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 761, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 762, */                     /* -fhelp */
  /* OPT_fhelp_ = 763, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 764,           /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 765,                      /* -fhonor-std */
  OPT_fhosted = 766,                         /* -fhosted */
  OPT_fhuge_objects = 767,                   /* -fhuge-objects */
  OPT_fident = 768,                          /* -fident */
  OPT_fif_conversion = 769,                  /* -fif-conversion */
  OPT_fif_conversion2 = 770,                 /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 771,         /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 772,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 773,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 774,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 775,             /* -fimplicit-templates */
  OPT_findirect_inlining = 776,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 777,         /* -finhibit-size-directive */
  OPT_finit_character_ = 778,                /* -finit-character= */
  OPT_finit_derived = 779,                   /* -finit-derived */
  OPT_finit_integer_ = 780,                  /* -finit-integer= */
  OPT_finit_local_zero = 781,                /* -finit-local-zero */
  OPT_finit_logical_ = 782,                  /* -finit-logical= */
  OPT_finit_real_ = 783,                     /* -finit-real= */
  OPT_finline = 784,                         /* -finline */
  OPT_finline_atomics = 785,                 /* -finline-atomics */
  OPT_finline_functions = 786,               /* -finline-functions */
  OPT_finline_functions_called_once = 787,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 788, */            /* -finline-limit- */
  OPT_finline_limit_ = 789,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 790,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 791,         /* -finline-small-functions */
  OPT_finput_charset_ = 792,                 /* -finput-charset= */
  OPT_finstrument_functions = 793,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 794,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 795,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 796,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 797,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 798,        /* -fintrinsic-modules-path= */
  OPT_finvariants = 799,                     /* -finvariants */
  OPT_fipa_bit_cp = 800,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 801,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 802, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 803,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 804,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 805,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 806,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 807, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 808,                    /* -fipa-profile */
  OPT_fipa_pta = 809,                        /* -fipa-pta */
  OPT_fipa_pure_const = 810,                 /* -fipa-pure-const */
  OPT_fipa_ra = 811,                         /* -fipa-ra */
  OPT_fipa_reference = 812,                  /* -fipa-reference */
  OPT_fipa_reference_addressable = 813,      /* -fipa-reference-addressable */
  OPT_fipa_sra = 814,                        /* -fipa-sra */
  OPT_fipa_stack_alignment = 815,            /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 816, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 817,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 818,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 819,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 820,              /* -fira-loop-pressure */
  OPT_fira_region_ = 821,                    /* -fira-region= */
  OPT_fira_share_save_slots = 822,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 823,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 824,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 825,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 826,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 827,               /* -fivar-visibility= */
  OPT_fivopts = 828,                         /* -fivopts */
  OPT_fjump_tables = 829,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 830,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 831,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 832,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 833,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 834,          /* -fkeep-static-functions */
  OPT_flabels_ok = 835,                      /* -flabels-ok */
  OPT_flax_vector_conversions = 836,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 837,             /* -fleading-underscore */
  OPT_flifetime_dse = 838,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 839,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 840,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 841,                 /* -flinker-output= */
  /* OPT_flive_patching = 842, */            /* -flive-patching */
  OPT_flive_patching_ = 843,                 /* -flive-patching= */
  OPT_flive_range_shrinkage = 844,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 845,                    /* -flocal-ivars */
  /* OPT_floop_block = 846, */               /* -floop-block */
  /* OPT_floop_flatten = 847, */             /* -floop-flatten */
  OPT_floop_interchange = 848,               /* -floop-interchange */
  OPT_floop_nest_optimize = 849,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 850, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 851,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 852, */          /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 853,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 854,                      /* -flra-remat */
  OPT_flto = 855,                            /* -flto */
  OPT_flto_compression_level_ = 856,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 857,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 858,                 /* -flto-partition= */
  OPT_flto_report = 859,                     /* -flto-report */
  OPT_flto_report_wpa = 860,                 /* -flto-report-wpa */
  OPT_flto_ = 861,                           /* -flto= */
  OPT_fltrans = 862,                         /* -fltrans */
  OPT_fltrans_output_list_ = 863,            /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 864,              /* -fmacro-prefix-map= */
  OPT_fmain = 865,                           /* -fmain */
  ...
  OPT_fmodule_file_ = 878,                   /* -fmodule-file= */
  OPT_fmodule_private = 879,                 /* -fmodule-private */
  OPT_fmoduleinfo = 880,                     /* -fmoduleinfo */
  OPT_fmodulo_sched = 881,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 882,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 883,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 884,                  /* -fms-extensions */
  OPT_fmudflap = 885,                        /* -fmudflap */
  OPT_fmudflapir = 886,                      /* -fmudflapir */
  OPT_fmudflapth = 887,                      /* -fmudflapth */
  OPT_fname_mangling_version_ = 888,         /* -fname-mangling-version- */
  OPT_fnew_abi = 889,                        /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 890,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 891,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 892,                   /* -fnext-runtime */
  OPT_fnil_receivers = 893,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 894,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 895,               /* -fnonansi-builtins */
  OPT_fnonnull_objects = 896,                /* -fnonnull-objects */
  OPT_fnothrow_opt = 897,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 898,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 899,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 900,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 901,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 902,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 903,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 904,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 905,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 906,                   /* -foffload-abi= */
  OPT_foffload_ = 907,                       /* -foffload= */
  OPT_fomit_frame_pointer = 908,             /* -fomit-frame-pointer */
  OPT_fonly_ = 909,                          /* -fonly= */
  OPT_fopenacc = 910,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 911,                   /* -fopenacc-dim= */
  OPT_fopenmp = 912,                         /* -fopenmp */
  OPT_fopenmp_simd = 913,                    /* -fopenmp-simd */
  OPT_foperator_names = 914,                 /* -foperator-names */
  OPT_fopt_info = 915,                       /* -fopt-info */
  OPT_fopt_info_ = 916,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 917, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 918,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 919,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 920, */           /* -foptional-diags */
  OPT_fpack_derived = 921,                   /* -fpack-derived */
  OPT_fpack_struct = 922,                    /* -fpack-struct */
  OPT_fpack_struct_ = 923,                   /* -fpack-struct= */
  OPT_fpad_source = 924,                     /* -fpad-source */
  OPT_fpartial_inlining = 925,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 926,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 927,              /* -fpcc-struct-return */
  OPT_fpch_deps = 928,                       /* -fpch-deps */
  OPT_fpch_preprocess = 929,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 930,                     /* -fpeel-loops */
  OPT_fpeephole = 931,                       /* -fpeephole */
  OPT_fpeephole2 = 932,                      /* -fpeephole2 */
  OPT_fpermissive = 933,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 934,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 935,                            /* -fpic */
  OPT_fpie = 936,                            /* -fpie */
  OPT_fplan9_extensions = 937,               /* -fplan9-extensions */
  OPT_fplt = 938,                            /* -fplt */
  OPT_fplugin_arg_ = 939,                    /* -fplugin-arg- */
  OPT_fplugin_ = 940,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 941,            /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 942,                 /* -fpostconditions */
  OPT_fpre_include_ = 943,                   /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 944,             /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 945,                  /* -fpreconditions */
  OPT_fpredictive_commoning = 946,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 947,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 948,                   /* -fpreprocessed */
  OPT_fpretty_templates = 949,               /* -fpretty-templates */
  OPT_fprintf_return_value = 950,            /* -fprintf-return-value */
  OPT_fprofile = 951,                        /* -fprofile */
  OPT_fprofile_abs_path = 952,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 953,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 954,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 955,                   /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 956,         /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 957,          /* -fprofile-filter-files= */
  OPT_fprofile_generate = 958,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 959,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 960,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 961,                 /* -fprofile-report */
  OPT_fprofile_update_ = 962,                /* -fprofile-update= */
  OPT_fprofile_use = 963,                    /* -fprofile-use */
  OPT_fprofile_use_ = 964,                   /* -fprofile-use= */
  OPT_fprofile_values = 965,                 /* -fprofile-values */
  OPT_fprotect_parens = 966,                 /* -fprotect-parens */
  OPT_frandom_seed = 967,                    /* -frandom-seed */
  OPT_frandom_seed_ = 968,                   /* -frandom-seed= */
  OPT_frange_check = 969,                    /* -frange-check */
  OPT_freal_4_real_10 = 970,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 971,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 972,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 973,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 974,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 975,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 976,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 977,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 978,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 979,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 980,                /* -frecord-marker=8 */
  OPT_frecursive = 981,                      /* -frecursive */
  OPT_free = 982,                            /* -free */
  OPT_freg_struct_return = 983,              /* -freg-struct-return */
  /* OPT_fregmove = 984, */                  /* -fregmove */
  OPT_frelease = 985,                        /* -frelease */
  OPT_frename_registers = 986,               /* -frename-registers */
  OPT_freorder_blocks = 987,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 988,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 989,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 990,              /* -freorder-functions */
  OPT_frepack_arrays = 991,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 992,           /* -freplace-objc-classes */
  OPT_frepo = 993,                           /* -frepo */
  OPT_freport_bug = 994,                     /* -freport-bug */
  OPT_frequire_return_statement = 995,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 996,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 997, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 998,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 999,                    /* -fresolution= */
  OPT_frounding_math = 1000,                 /* -frounding-math */
  OPT_frtti = 1001,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1002,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1003,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1004,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1005,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1006,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1007,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1008,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1009,      /* -fsave-optimization-record */
  ...
  OPT_fsplit_ivs_in_unroller = 1054,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1055,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1056,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1057,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1058,              /* -fsplit-wide-types */
  OPT_fsquangle = 1059,                      /* -fsquangle */
  OPT_fssa_backprop = 1060,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1061,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1062,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1063,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1064, */             /* -fstack-check */
  OPT_fstack_check_ = 1065,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1066,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1067,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1068,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1069,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1070,               /* -fstack-protector */
  OPT_fstack_protector_all = 1071,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1072,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1073,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1074,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1075,                   /* -fstack-usage */
  OPT_fstats = 1076,                         /* -fstats */
  OPT_fstdarg_opt = 1077,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1078,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1079, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1080,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1081,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1082,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1083,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1084,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1085, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1086,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1087,                 /* -fswitch-errors */
  ...
  OPT_ftest_coverage = 1095,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1096,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1097,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1098,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1099,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1100,                   /* -ftime-report */
  OPT_ftime_report_details = 1101,           /* -ftime-report-details */
  OPT_ftls_model_ = 1102,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1103,              /* -ftoplevel-reorder */
  OPT_ftracer = 1104,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1105,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1106,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1107,                   /* -ftrampolines */
  OPT_ftransition_all = 1108,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1109,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1110,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1111,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1112,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1113,              /* -ftransition=field */
  OPT_ftransition_import = 1114,             /* -ftransition=import */
  OPT_ftransition_nogc = 1115,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1116,                /* -ftransition=tls */
  OPT_ftrapping_math = 1117,                 /* -ftrapping-math */
  OPT_ftrapv = 1118,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1119,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1120,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1121,                      /* -ftree-ccp */
  OPT_ftree_ch = 1122,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1123, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1124,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1125,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1126, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1127,                   /* -ftree-cselim */
  OPT_ftree_dce = 1128,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1129,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1130,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1131,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1132,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1133, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1134,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1135,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1136, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1137,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1138,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1139, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1140,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1141,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1142,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1143,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1144,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1145,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1146,                      /* -ftree-pre */
  OPT_ftree_pta = 1147,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1148,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1149, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1150,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1151,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1152,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1153,                     /* -ftree-slsr */
  OPT_ftree_sra = 1154,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1155, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1156, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1157,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1158,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1159,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1160, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1161,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1162, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1163,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1164,         /* -funconstrained-commons */
  OPT_funderscoring = 1165,                  /* -funderscoring */
  OPT_funit_at_a_time = 1166,                /* -funit-at-a-time */
  OPT_funittest = 1167,                      /* -funittest */
  OPT_funroll_all_loops = 1168,              /* -funroll-all-loops */
  OPT_funroll_loops = 1169,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1170, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1171,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1172,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1173,                 /* -funsigned-char */
  OPT_funswitch_loops = 1174,                /* -funswitch-loops */
  OPT_funwind_tables = 1175,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1176,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1177,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1178,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1179,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1180,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1181,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1182,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1183,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1184,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1185,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1186,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1187, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1188,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1189,                   /* -fverbose-asm */
  /* OPT_fversion = 1190, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1191,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1192,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1193,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1194,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1195,                   /* -fvisibility= */
  OPT_fvpt = 1196,                           /* -fvpt */
  OPT_fvtable_gc = 1197,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1198,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1199,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1200,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1201,                     /* -fvtv-debug */
  OPT_fweak = 1202,                          /* -fweak */
  OPT_fweb = 1203,                           /* -fweb */
  /* OPT_fwhole_file = 1204, */              /* -fwhole-file */
  OPT_fwhole_program = 1205,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1206,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1207,             /* -fworking-directory */
  OPT_fwpa = 1208,                           /* -fwpa */
  OPT_fwpa_ = 1209,                          /* -fwpa= */
  OPT_fwrapv = 1210,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1211,                 /* -fwrapv-pointer */
  OPT_fxref = 1212,                          /* -fxref */
  /* OPT_fzee = 1213, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1214,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1215,                     /* -fzero-link */
  OPT_g = 1216,                              /* -g */
  OPT_gant = 1217,                           /* -gant */
  OPT_gas_loc_support = 1218,                /* -gas-loc-support */
  OPT_gas_locview_support = 1219,            /* -gas-locview-support */
  OPT_gcoff = 1220,                          /* -gcoff */
  OPT_gcoff1 = 1221,                         /* -gcoff1 */
  OPT_gcoff2 = 1222,                         /* -gcoff2 */
  OPT_gcoff3 = 1223,                         /* -gcoff3 */
  OPT_gcolumn_info = 1224,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1225,                 /* -gdescribe-dies */
  OPT_gdwarf = 1226,                         /* -gdwarf */
  OPT_gdwarf_ = 1227,                        /* -gdwarf- */
  OPT_gen_decls = 1228,                      /* -gen-decls */
  OPT_ggdb = 1229,                           /* -ggdb */
  OPT_ggnu_pubnames = 1230,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1231,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1232, /* -ginternal-reset-location-views */
  OPT_gnat = 1233,                           /* -gnat */
  OPT_gnatO = 1234,                          /* -gnatO */
  OPT_gno_ = 1235,                           /* -gno- */
  OPT_gno_pubnames = 1236,                   /* -gno-pubnames */
  OPT_gpubnames = 1237,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1238,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1239,                   /* -gsplit-dwarf */
  OPT_gstabs = 1240,                         /* -gstabs */
  OPT_gstabs_ = 1241,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1242,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1243,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1244,                        /* -gtoggle */
  OPT_gvariable_location_views = 1245,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1246,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1247,                           /* -gvms */
  OPT_gxcoff = 1248,                         /* -gxcoff */
  OPT_gxcoff_ = 1249,                        /* -gxcoff+ */
  OPT_gz = 1250,                             /* -gz */
  OPT_gz_ = 1251,                            /* -gz= */
  OPT_h = 1252,                              /* -h */
  OPT_idirafter = 1253,                      /* -idirafter */
  OPT_imacros = 1254,                        /* -imacros */
  OPT_imultiarch = 1255,                     /* -imultiarch */
  OPT_imultilib = 1256,                      /* -imultilib */
  OPT_include = 1257,                        /* -include */
  OPT_iplugindir_ = 1258,                    /* -iplugindir= */
  OPT_iprefix = 1259,                        /* -iprefix */
  OPT_iquote = 1260,                         /* -iquote */
  OPT_isysroot = 1261,                       /* -isysroot */
  OPT_isystem = 1262,                        /* -isystem */
  OPT_iwithprefix = 1263,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1264,              /* -iwithprefixbefore */
  OPT_k8 = 1265,                             /* -k8 */
  OPT_l = 1266,                              /* -l */
  OPT_lang_asm = 1267,                       /* -lang-asm */
  OPT_mabi_ = 1268,                          /* -mabi= */
  OPT_march_ = 1269,                         /* -march= */
  OPT_mbig_endian = 1270,                    /* -mbig-endian */
  OPT_mbionic = 1271,                        /* -mbionic */
  OPT_mbranch_protection_ = 1272,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1273,                       /* -mcmodel= */
  OPT_mcpu_ = 1274,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1275,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1276,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1277,             /* -mgeneral-regs-only */
  OPT_mglibc = 1278,                         /* -mglibc */
  ...
  OPT_mmusl = 1283,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1284,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1285,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1286,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1287,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1288, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1289,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1290,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1291,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1292,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1293,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1294,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1295,             /* -mtrack-speculation */
  OPT_mtune_ = 1296,                         /* -mtune= */
  OPT_muclibc = 1297,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1298,             /* -mverbose-cost-dump */
  OPT_n = 1299,                              /* -n */
  OPT_no_canonical_prefixes = 1300,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1301,              /* -no-integrated-cpp */
  OPT_no_pie = 1302,                         /* -no-pie */
  OPT_nocpp = 1303,                          /* -nocpp */
  OPT_nodefaultlibs = 1304,                  /* -nodefaultlibs */
  OPT_nolibc = 1305,                         /* -nolibc */
  OPT_nophoboslib = 1306,                    /* -nophoboslib */
  ...
  OPT_shared_libphobos = 1342,               /* -shared-libphobos */
  ...
  OPT_static_libphobos = 1353,               /* -static-libphobos */
  OPT_static_libstdc__ = 1354,               /* -static-libstdc++ */
  OPT_static_libtsan = 1355,                 /* -static-libtsan */
  OPT_static_libubsan = 1356,                /* -static-libubsan */
  OPT_static_pie = 1357,                     /* -static-pie */
  /* OPT_std_c__03 = 1358, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1359, */                /* -std=c++0x */
  OPT_std_c__11 = 1360,                      /* -std=c++11 */
  OPT_std_c__14 = 1361,                      /* -std=c++14 */
  OPT_std_c__17 = 1362,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1363, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1364, */                /* -std=c++1z */
  OPT_std_c__2a = 1365,                      /* -std=c++2a */
  OPT_std_c__98 = 1366,                      /* -std=c++98 */
  OPT_std_c11 = 1367,                        /* -std=c11 */
  OPT_std_c17 = 1368,                        /* -std=c17 */
  /* OPT_std_c18 = 1369, */                  /* -std=c18 */
  /* OPT_std_c1x = 1370, */                  /* -std=c1x */
  OPT_std_c2x = 1371,                        /* -std=c2x */
  /* OPT_std_c89 = 1372, */                  /* -std=c89 */
  OPT_std_c90 = 1373,                        /* -std=c90 */
  OPT_std_c99 = 1374,                        /* -std=c99 */
  /* OPT_std_c9x = 1375, */                  /* -std=c9x */
  OPT_std_f2003 = 1376,                      /* -std=f2003 */
  OPT_std_f2008 = 1377,                      /* -std=f2008 */
  OPT_std_f2008ts = 1378,                    /* -std=f2008ts */
  OPT_std_f2018 = 1379,                      /* -std=f2018 */
  ...
  OPT_std_gnu__2a = 1389,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1390,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1391,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1392,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1393, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1394, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1395,                      /* -std=gnu2x */
  ...
  /* OPT_std_iso9899_2017 = 1405, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1406, */         /* -std=iso9899:2018 */
