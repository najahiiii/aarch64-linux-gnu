...
enum opt_code
{
  ...
  OPT_mtls_dialect_ = 1149,                  /* -mtls-dialect= */
  ...
  OPT_static_liblsan = 1201,                 /* -static-liblsan */
  OPT_static_libmpx = 1202,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1203,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1204,               /* -static-libstdc++ */
  OPT_static_libtsan = 1205,                 /* -static-libtsan */
  OPT_static_libubsan = 1206,                /* -static-libubsan */
  /* OPT_std_c__03 = 1207, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1208, */                /* -std=c++0x */
  OPT_std_c__11 = 1209,                      /* -std=c++11 */
  OPT_std_c__14 = 1210,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1211, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1212, */                /* -std=c++1y */
  OPT_std_c__1z = 1213,                      /* -std=c++1z */
  OPT_std_c__98 = 1214,                      /* -std=c++98 */
  OPT_std_c11 = 1215,                        /* -std=c11 */
  /* OPT_std_c1x = 1216, */                  /* -std=c1x */
  /* OPT_std_c89 = 1217, */                  /* -std=c89 */
  OPT_std_c90 = 1218,                        /* -std=c90 */
  OPT_std_c99 = 1219,                        /* -std=c99 */
  /* OPT_std_c9x = 1220, */                  /* -std=c9x */
  OPT_std_f2003 = 1221,                      /* -std=f2003 */
  OPT_std_f2008 = 1222,                      /* -std=f2008 */
  OPT_std_f2008ts = 1223,                    /* -std=f2008ts */
  OPT_std_f95 = 1224,                        /* -std=f95 */
  OPT_std_gnu = 1225,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1226, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1227, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1228,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1229,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1230, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1231, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1232,                    /* -std=gnu++1z */
  ...
  OPT_time = 1248,                           /* -time */
  OPT_time_ = 1249,                          /* -time= */
  OPT_traditional = 1250,                    /* -traditional */
  OPT_traditional_cpp = 1251,                /* -traditional-cpp */
  OPT_trigraphs = 1252,                      /* -trigraphs */
  OPT_u = 1253,                              /* -u */
  OPT_undef = 1254,                          /* -undef */
  OPT_v = 1255,                              /* -v */
  OPT_version = 1256,                        /* -version */
  OPT_w = 1257,                              /* -w */
  OPT_wrapper = 1258,                        /* -wrapper */
  OPT_x = 1259,                              /* -x */
  OPT_z = 1260,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
